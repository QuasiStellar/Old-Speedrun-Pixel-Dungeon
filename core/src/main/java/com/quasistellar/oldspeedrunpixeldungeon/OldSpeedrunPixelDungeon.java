...
import com.quasistellar.oldspeedrunpixeldungeon.scenes.WelcomeScene;
...
public class OldSpeedrunPixelDungeon extends Game {
	...
	public OldSpeedrunPixelDungeon() {
	...
	public static void landscape( boolean value ) {
		...
		((OldSpeedrunPixelDungeon)instance).updateDisplaySize();
	}
	...
	public static void immerse( boolean value ) {
		...
		instance.runOnUiThread( new Runnable() {
			...
			public void run() {
				...
				((OldSpeedrunPixelDungeon)instance).view.getHolder().setSizeFromLayout();
			}
		} );
	}
