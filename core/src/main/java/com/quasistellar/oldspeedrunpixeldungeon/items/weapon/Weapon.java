...
package com.quasistellar.oldspeedrunpixeldungeon.items.weapon;
...
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.curses.Annoying;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.curses.Displacing;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.curses.Exhausting;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.curses.Fragile;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.curses.Sacrificial;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.curses.Wayward;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.enchantments.Blazing;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.enchantments.Chilling;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.enchantments.Dazzling;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.enchantments.Eldritch;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.enchantments.Grim;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.enchantments.Lucky;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.enchantments.Projecting;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.enchantments.Shocking;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.enchantments.Stunning;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.enchantments.Unstable;
...
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.enchantments.Vorpal;
import com.quasistellar.oldspeedrunpixeldungeon.items.weapon.melee.MeleeWeapon;
