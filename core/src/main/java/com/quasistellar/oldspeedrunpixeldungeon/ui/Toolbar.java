...
package com.quasistellar.oldspeedrunpixeldungeon.ui;
...
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndJournal;
...
public class Toolbar extends Component {
	...
	protected void layout() {
		...
		int slots = OldSpeedrunPixelDungeon.quickSlots();
		...
		for(int i = 0; i <= 3; i++) {
			...
			if (slots == 4 && width < 152){
				if (width < 138){
					if ((OldSpeedrunPixelDungeon.flipToolbar() && i == 3) ||
							(!OldSpeedrunPixelDungeon.flipToolbar() && i == 0)) {
					...
					if (i == 0 && !OldSpeedrunPixelDungeon.flipToolbar() ||
						i == 3 && OldSpeedrunPixelDungeon.flipToolbar()){
						btnQuick[i].border(0, 2);
						btnQuick[i].frame(106, 0, 19, 24);
					} else if (i == 0 && OldSpeedrunPixelDungeon.flipToolbar() ||
							i == 3 && !OldSpeedrunPixelDungeon.flipToolbar()){
		...
		float right = width;
		switch(Mode.valueOf(OldSpeedrunPixelDungeon.toolbarMode())){
			case SPLIT:
				btnWait.setPos(x, y);
		...
		if (OldSpeedrunPixelDungeon.flipToolbar()) {
