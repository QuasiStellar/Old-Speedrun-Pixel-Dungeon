...
import com.quasistellar.oldspeedrunpixeldungeon.Chrome;
import com.quasistellar.oldspeedrunpixeldungeon.OldSpeedrunPixelDungeon;
import com.quasistellar.oldspeedrunpixeldungeon.effects.BadgeBanner;
...
import com.quasistellar.oldspeedrunpixeldungeon.items.food.Blandfruit;
...
import com.quasistellar.oldspeedrunpixeldungeon.items.stones.StoneOfEnchantment;
...
import com.quasistellar.oldspeedrunpixeldungeon.ui.ScrollPane;
import com.quasistellar.oldspeedrunpixeldungeon.ui.Window;
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndTitledMessage;
...
public class ChangesScene extends PixelScene {
	...
	private static class ChangeButton extends Component {
		...
		protected void onClick() {
			OldSpeedrunPixelDungeon.scene().add(new ChangesWindow(new Image(icon), title, message));
		}
