...
import com.quasistellar.oldspeedrunpixeldungeon.ui.ChangesButton;
import com.quasistellar.oldspeedrunpixeldungeon.ui.ExitButton;
import com.quasistellar.oldspeedrunpixeldungeon.ui.LanguageButton;
import com.quasistellar.oldspeedrunpixeldungeon.ui.PrefsButton;
	...
	public void create() {
		...
		DashboardItem btnBadges = new DashboardItem( Messages.get(this, "badges"), 3 ) {
			...
			protected void onClick() {
				OldSpeedrunPixelDungeon.switchNoFade( BadgesScene.class );
			}
		};
		add(btnBadges);
		...
		DashboardItem btnAbout = new DashboardItem( Messages.get(this, "about"), 1 ) {
			@Override
			protected void onClick() {
				OldSpeedrunPixelDungeon.switchNoFade( AboutScene.class );
			}
		};
		add( btnAbout );
		...
		DashboardItem btnRankings = new DashboardItem( Messages.get(this, "rankings"), 2 ) {
			@Override
			protected void onClick() {
				OldSpeedrunPixelDungeon.switchNoFade( RankingsScene.class );
			}
		};
		add( btnRankings );
