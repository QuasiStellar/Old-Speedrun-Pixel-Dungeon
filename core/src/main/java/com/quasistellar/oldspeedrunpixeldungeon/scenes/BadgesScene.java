...
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndBadge;
...
public class BadgesScene extends PixelScene {
	...
	public void create() {
		...
		int nCols = OldSpeedrunPixelDungeon.landscape() ? 7 : 4;
		if (badges.size() + blankBadges > 32 && !OldSpeedrunPixelDungeon.landscape())	nCols++;
