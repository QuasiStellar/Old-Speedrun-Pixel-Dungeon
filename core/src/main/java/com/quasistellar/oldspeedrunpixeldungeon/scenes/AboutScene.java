...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		final float colWidth = Camera.main.width / (OldSpeedrunPixelDungeon.landscape() ? 2 : 1);
		final float colTop = (Camera.main.height / 2) - (OldSpeedrunPixelDungeon.landscape() ? 30 : 90);
		final float wataOffset = OldSpeedrunPixelDungeon.landscape() ? colWidth : 0;
		...
		wata.y = OldSpeedrunPixelDungeon.landscape() ?
						colTop:
