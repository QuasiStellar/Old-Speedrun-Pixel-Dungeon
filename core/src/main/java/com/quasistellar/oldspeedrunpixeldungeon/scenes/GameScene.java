...
import com.quasistellar.oldspeedrunpixeldungeon.effects.EmoIcon;
import com.quasistellar.oldspeedrunpixeldungeon.effects.Flare;
import com.quasistellar.oldspeedrunpixeldungeon.effects.FloatingText;
import com.quasistellar.oldspeedrunpixeldungeon.effects.Ripple;
...
import com.quasistellar.oldspeedrunpixeldungeon.items.Honeypot;
import com.quasistellar.oldspeedrunpixeldungeon.items.Item;
import com.quasistellar.oldspeedrunpixeldungeon.items.bags.PotionBandolier;
import com.quasistellar.oldspeedrunpixeldungeon.items.bags.ScrollHolder;
import com.quasistellar.oldspeedrunpixeldungeon.items.bags.SeedPouch;
import com.quasistellar.oldspeedrunpixeldungeon.items.bags.WandHolster;
...
import com.quasistellar.oldspeedrunpixeldungeon.journal.Journal;
...
import com.quasistellar.oldspeedrunpixeldungeon.levels.traps.Trap;
...
import com.quasistellar.oldspeedrunpixeldungeon.sprites.DiscardedItemSprite;
...
import com.quasistellar.oldspeedrunpixeldungeon.tiles.DungeonTileSheet;
import com.quasistellar.oldspeedrunpixeldungeon.tiles.DungeonTilemap;
import com.quasistellar.oldspeedrunpixeldungeon.tiles.DungeonWallsTilemap;
import com.quasistellar.oldspeedrunpixeldungeon.tiles.FogOfWar;
import com.quasistellar.oldspeedrunpixeldungeon.tiles.GridTileMap;
import com.quasistellar.oldspeedrunpixeldungeon.tiles.TerrainFeaturesTilemap;
import com.quasistellar.oldspeedrunpixeldungeon.tiles.WallBlockingTilemap;
import com.quasistellar.oldspeedrunpixeldungeon.ui.ActionIndicator;
import com.quasistellar.oldspeedrunpixeldungeon.ui.AttackIndicator;
import com.quasistellar.oldspeedrunpixeldungeon.ui.Banner;
import com.quasistellar.oldspeedrunpixeldungeon.ui.BusyIndicator;
import com.quasistellar.oldspeedrunpixeldungeon.ui.CharHealthIndicator;
import com.quasistellar.oldspeedrunpixeldungeon.ui.GameLog;
import com.quasistellar.oldspeedrunpixeldungeon.ui.LootIndicator;
import com.quasistellar.oldspeedrunpixeldungeon.ui.QuickSlotButton;
import com.quasistellar.oldspeedrunpixeldungeon.ui.ResumeIndicator;
import com.quasistellar.oldspeedrunpixeldungeon.ui.StatusPane;
import com.quasistellar.oldspeedrunpixeldungeon.ui.TargetHealthIndicator;
import com.quasistellar.oldspeedrunpixeldungeon.ui.Toast;
import com.quasistellar.oldspeedrunpixeldungeon.ui.Toolbar;
...
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndBag.Mode;
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndGame;
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndHero;
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndInfoCell;
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndInfoItem;
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndInfoMob;
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndInfoPlant;
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndInfoTrap;
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndMessage;
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndOptions;
import com.quasistellar.oldspeedrunpixeldungeon.windows.WndStory;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		OldSpeedrunPixelDungeon.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + OldSpeedrunPixelDungeon.zoom(), maxZoom));
	...
	public static void layoutTags() {
		...
		float tagLeft = OldSpeedrunPixelDungeon.flipTags() ? 0 : uiCamera.width - scene.attack.width();

		if (OldSpeedrunPixelDungeon.flipTags()) {
