...
import com.quasistellar.oldspeedrunpixeldungeon.plants.Plant.Seed;
...
import com.quasistellar.oldspeedrunpixeldungeon.ui.ItemSlot;
...
public class WndBag extends WndTabbed {
	...
	public WndBag( Bag bag, Listener listener, Mode mode, String title ) {
		...
		nCols = OldSpeedrunPixelDungeon.landscape() ? COLS_L : COLS_P;
