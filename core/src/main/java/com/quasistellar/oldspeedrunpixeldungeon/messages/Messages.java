...
package com.quasistellar.oldspeedrunpixeldungeon.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.quasistellar.oldspeedrunpixeldungeon.messages.actors.actors",
			"com.quasistellar.oldspeedrunpixeldungeon.messages.items.items",
			"com.quasistellar.oldspeedrunpixeldungeon.messages.journal.journal",
			"com.quasistellar.oldspeedrunpixeldungeon.messages.levels.levels",
			"com.quasistellar.oldspeedrunpixeldungeon.messages.plants.plants",
			"com.quasistellar.oldspeedrunpixeldungeon.messages.scenes.scenes",
			"com.quasistellar.oldspeedrunpixeldungeon.messages.ui.ui",
			"com.quasistellar.oldspeedrunpixeldungeon.messages.windows.windows",
			"com.quasistellar.oldspeedrunpixeldungeon.messages.misc.misc"
	};

	static{
		setup(OldSpeedrunPixelDungeon.language());
	}
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.quasistellar.oldspeedrunpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
